        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<News>().HasData(
                new News
                {
                    ...
                    Timestamp = DateTime.Now,
                    SourceCreate = Enums.SourceCreate.GoogleApi,
                    OfficialRating = Enums.LabelNews.real
                },
                new News
                {
                    NewsId = 2,
                ...
                new News
                {
                    ...
                    Timestamp = DateTime.Now,
                    SourceCreate = Enums.SourceCreate.GoogleApi,
                    OfficialRating = Enums.LabelNews.undefined,
                },
                new News
                {
                    NewsId = 5,
                    ...
                    Timestamp = DateTime.Now,
                    OfficialRating = Enums.LabelNews.undefined,
                    SourceCreate = Enums.SourceCreate.NewsApi
                },
                new News
                {
                    NewsId = 6,
                    ...
                    Timestamp = DateTime.Now,
                    OfficialRating = Enums.LabelNews.fake,
                    SourceCreate = Enums.SourceCreate.NewsApi
                },
                new News
                {
