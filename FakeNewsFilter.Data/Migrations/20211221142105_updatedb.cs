        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 21, 21, 21, 5, 12, DateTimeKind.Local).AddTicks(5084)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 21, 21, 21, 5, 11, DateTimeKind.Local).AddTicks(4422))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsId = table.Column<int>(type: "int", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 21, 21, 21, 5, 9, DateTimeKind.Local).AddTicks(3291))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1142), 0, 0L, "covid.jpeg", 0, 1 },
                    { 2, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1143), 0, 0L, "taliban.jpeg", 0, 1 },
                    { 3, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1144), 0, 0L, "kinh-te-tg.jpeg", 0, 1 },
                    { 4, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1144), 0, 0L, "ngvietnamchau.jpeg", 0, 1 },
                    { 5, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1146), 0, 0L, "doanh-nghiep.jpeg", 0, 1 },
                    { 6, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1147), 0, 0L, "chon truong.jpeg", 0, 1 },
                    { 7, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1147), 0, 0L, "congnghegame.jpeg", 0, 1 },
                    { 8, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1148), 0, 0L, "congnghemoi.jpeg", 0, 1 },
                    { 9, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1149), 0, 0L, "phongsu.jpeg", 0, 1 },
                    { 10, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1149), 0, 0L, "giaothong.jpeg", 0, 1 },
                    { 11, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1150), 0, 0L, "chungkhoan.jpeg", 0, 1 },
                    { 12, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1151), 0, 0L, "khoahocvn.jpeg", 0, 1 },
                    { 13, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1151), 0, 0L, "the-thao1.jpeg", 0, 1 },
                    { 14, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1152), 0, 0L, "newsid1.jpg", 0, 1 },
                    { 15, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1153), 0, 0L, "newsid2.jpg", 0, 1 },
                    { 16, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1153), 0, 0L, "newsid3.jpg", 0, 1 },
                    { 17, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1154), 0, 0L, "newsid4.jpg", 0, 1 },
                    { 18, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1155), 0, 0L, "newsid5.jpg", 0, 1 },
                    { 19, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1155), 0, 0L, "newsid6.png", 0, 1 },
                    { 20, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1156), 0, 0L, "newsid7.jpg", 0, 1 },
                    { 21, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1157), 0, 0L, "newsid8.jpg", 0, 1 },
                    { 22, null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1159), 0, 0L, "newsid9.jpg", 0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a3314be5-4c77-4fb6-82ad-302014682a73"), "4cc98292-64e8-4999-a205-409652285322", "Admin", "Admin" },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), "de195196-3e3b-4eab-b267-45092c40ba0b", "Subscriber", "Subscriber" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, null, "2db6fbc9-fa7b-48ab-b5fa-ebaf33e2bc6f", "bp.khuyen@hutech.edu.vn", true, false, null, "Bui Phu Khuyen", "BP.KHUYEN@HUTECH.EDU.VN", "khuyenpb", "AQAAAAEAACcQAAAAEFAg31Taq4e3f3xevQY0LqPrCbFVB7cRjpdEd+0q3Cj0UJBBnW3XEGs7/X+SiqgJ0g==", null, false, "", false, "khuyenpb" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be02de"), 0, null, "9c4e3bb0-a611-4831-b584-764cd3a16cdf", "thanh26092000@gmail.com", true, false, null, "Le Xuan Thanh", "THANH26092000@GMAIL.COM", "LXThanh", "AQAAAAEAACcQAAAAEMBy/AGzgsXJWy0mxC+3/+szcf9bEFnCuNPLElId+UVhhQAjnOvAGG1sYnEsd2tjaA==", null, false, "", false, "LXThanh" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be03de"), 0, null, "4c42eed3-5638-4bef-b69b-4d48210e76e3", "khanh200111@gmail.com", true, false, null, "Huynh Huu Khanh", "KHANH200111@GMAIL.COM", "hkhansh27", "AQAAAAEAACcQAAAAEHarTQB3HB5yEVx3BM3xZW03FmLwGeJ27gzpNVZmNKqAbmILVd3sqb3TViKas2vrRw==", null, false, "", false, "hkhansh27" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be04de"), 0, null, "b9da033b-8274-449a-a440-7f881bc3b86f", "hi@phucs.me", true, false, null, "To Hoang Phuc", "HI@PHUCS.ME", "HoangPhuc", "AQAAAAEAACcQAAAAEA3UT46/stjTsdxfr1cCqZZv3irNtSrQAaGHW1NMwZsLLvU2gguceP66V6LjC4r/XA==", null, false, "", false, "HoangPhuc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Follow live as the Taliban seizes territory across Afghanistan in the wake of the U.S. withdrawal.", "breaking", "en", "afghanistan", null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1084), null },
                    { 2, "Best nonfiction features, in-depth stores and other long-form content from across the web.", "featured", "en", "in-depth", 2, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1097), null },
                    { 3, "Outbreak of respiratory virus that has killed over 1 million and infected 100 milion worldwide.", "featured", "en", "coronavirus", null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1099), null },
                    { 4, "The top business and economic news from around the world with a focus on the United State.", "featured", "en", "top-business", null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1100), null },
                    { 5, "Follow the presidential transition of Joe Biden, including policy plans, appointments and more.", "featured", "en", "biden-admin", null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1102), null },
                    { 6, "Top stories from around the world with a focus on news not covered in other feeds.", "featured", "en", "top-news", null, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1103), null },
                    { 7, "Follow important local news: politics, business, top events and more. Updated everything evening.", "featured", "en", "boston", 1, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1105), null },
                    { 8, "Các thông tin về virut corona.", "Thế giới", "vi", "dịch bệnh", 3, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1106), null },
                    { 9, "Cuộc sống của người Việt Trên toàn thế giới.", "Thế giới", "vi", "người Việt Nam", 4, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1106), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, " Nền doanh nghiệp Việt Nam.", "TÀI CHÍNH - KINH DOANH", "vi", "Kinh tế", 5, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1107), null },
                    { 11, "Chọn trường nghề phù hợp với bản thân.", "GIÁO DỤC", "vi", "học hành", 6, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1109), null },
                    { 12, "Công nghệ mới trong game.", "Trò chơi", "vi", "Trò chơi", 7, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1110), null },
                    { 13, " Sản phẩm công nghệ mới trong năm.", "Công Nghệ", "vi", "Sản phẩm", 8, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1111), null },
                    { 14, " Phóng sự đời sống thường nhật của người dân.", "Thời sự", "vi", "Phóng sự", 9, new DateTime(2021, 12, 21, 21, 21, 5, 40, DateTimeKind.Local).AddTicks(1111), null }
                });
