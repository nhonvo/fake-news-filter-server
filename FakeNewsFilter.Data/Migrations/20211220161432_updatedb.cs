        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 20, 23, 14, 31, 501, DateTimeKind.Local).AddTicks(8498)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 20, 23, 14, 31, 501, DateTimeKind.Local).AddTicks(160))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsId = table.Column<int>(type: "int", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 20, 23, 14, 31, 498, DateTimeKind.Local).AddTicks(7216))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2729), 0, 0L, "covid.jpeg", 0, 1 },
                    { 2, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2736), 0, 0L, "taliban.jpeg", 0, 1 },
                    { 3, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2739), 0, 0L, "kinh-te-tg.jpeg", 0, 1 },
                    { 4, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2743), 0, 0L, "ngvietnamchau.jpeg", 0, 1 },
                    { 5, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2744), 0, 0L, "doanh-nghiep.jpeg", 0, 1 },
                    { 6, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2745), 0, 0L, "chon truong.jpeg", 0, 1 },
                    { 7, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2746), 0, 0L, "congnghegame.jpeg", 0, 1 },
                    { 8, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2747), 0, 0L, "congnghemoi.jpeg", 0, 1 },
                    { 9, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2749), 0, 0L, "phongsu.jpeg", 0, 1 },
                    { 10, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2750), 0, 0L, "giaothong.jpeg", 0, 1 },
                    { 11, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2754), 0, 0L, "chungkhoan.jpeg", 0, 1 },
                    { 12, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2756), 0, 0L, "khoahocvn.jpeg", 0, 1 },
                    { 13, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2759), 0, 0L, "the-thao1.jpeg", 0, 1 },
                    { 14, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2762), 0, 0L, "newsid1.jpg", 0, 1 },
                    { 15, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2765), 0, 0L, "newsid2.jpg", 0, 1 },
                    { 16, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2767), 0, 0L, "newsid3.jpg", 0, 1 },
                    { 17, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2769), 0, 0L, "newsid4.jpg", 0, 1 },
                    { 18, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2772), 0, 0L, "newsid5.jpg", 0, 1 },
                    { 19, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2775), 0, 0L, "newsid6.png", 0, 1 },
                    { 20, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2777), 0, 0L, "newsid7.jpg", 0, 1 },
                    { 21, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2780), 0, 0L, "newsid8.jpg", 0, 1 },
                    { 22, null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2781), 0, 0L, "newsid9.jpg", 0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a3314be5-4c77-4fb6-82ad-302014682a73"), "de73c355-99cd-48e9-8a87-7c3f2e02ee75", "Admin", "Admin" },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), "3596f099-b805-40c0-8e68-4aca5bb44e38", "Subscriber", "Subscriber" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, null, "488422e9-0426-40c9-91b0-e27222959887", "bp.khuyen@hutech.edu.vn", true, false, null, "Bui Phu Khuyen", "BP.KHUYEN@HUTECH.EDU.VN", "khuyenpb", "AQAAAAEAACcQAAAAEJT7NB4mIdYZw3JMoQjqMdiO9+w2+HQwI6BFUFXqwioriKFk12d/MSYkORm9AsKFiw==", null, false, "", false, "khuyenpb" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be02de"), 0, null, "9b2c0717-8a03-4137-96fe-1e450d791f54", "thanh26092000@gmail.com", true, false, null, "Le Xuan Thanh", "THANH26092000@GMAIL.COM", "LXThanh", "AQAAAAEAACcQAAAAEFHRQdT/hth1wBw+MD7dAUpH+rgcuxQSHWWbKA7Rc13q9V1sPhRrngCl9zK/88vzfA==", null, false, "", false, "LXThanh" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be03de"), 0, null, "308e6d9c-2d93-40f3-a457-94bc396116ef", "khanh200111@gmail.com", true, false, null, "Huynh Huu Khanh", "KHANH200111@GMAIL.COM", "hkhansh27", "AQAAAAEAACcQAAAAEMJKCV3KffWhMIGQNNY1uqhxAU0F9InIFbYxuhv7u4SczNmiRsUIcNAbkgK6aoFWIg==", null, false, "", false, "hkhansh27" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be04de"), 0, null, "15215f5b-9129-41a5-bf0a-e40ab7348fb4", "hi@phucs.me", true, false, null, "To Hoang Phuc", "HI@PHUCS.ME", "HoangPhuc", "AQAAAAEAACcQAAAAEKWpQEylAJr7XwxQ7nzpzhed8yViZMBVcQwS9vgkInKElyhGnjnZQOPpwZpZhuVOKg==", null, false, "", false, "HoangPhuc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Follow live as the Taliban seizes territory across Afghanistan in the wake of the U.S. withdrawal.", "breaking", "en", "afghanistan", null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2612), null },
                    { 2, "Best nonfiction features, in-depth stores and other long-form content from across the web.", "featured", "en", "in-depth", 2, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2626), null },
                    { 3, "Outbreak of respiratory virus that has killed over 1 million and infected 100 milion worldwide.", "featured", "en", "coronavirus", null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2630), null },
                    { 4, "The top business and economic news from around the world with a focus on the United State.", "featured", "en", "top-business", null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2638), null },
                    { 5, "Follow the presidential transition of Joe Biden, including policy plans, appointments and more.", "featured", "en", "biden-admin", null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2639), null },
                    { 6, "Top stories from around the world with a focus on news not covered in other feeds.", "featured", "en", "top-news", null, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2642), null },
                    { 7, "Follow important local news: politics, business, top events and more. Updated everything evening.", "featured", "en", "boston", 1, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2643), null },
                    { 8, "Các thông tin về virut corona.", "Thế giới", "vi", "dịch bệnh", 3, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2644), null },
                    { 9, "Cuộc sống của người Việt Trên toàn thế giới.", "Thế giới", "vi", "người Việt Nam", 4, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2647), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, " Nền doanh nghiệp Việt Nam.", "TÀI CHÍNH - KINH DOANH", "vi", "Kinh tế", 5, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2650), null },
                    { 11, "Chọn trường nghề phù hợp với bản thân.", "GIÁO DỤC", "vi", "học hành", 6, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2653), null },
                    { 12, "Công nghệ mới trong game.", "Trò chơi", "vi", "Trò chơi", 7, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2656), null },
                    { 13, " Sản phẩm công nghệ mới trong năm.", "Công Nghệ", "vi", "Sản phẩm", 8, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2659), null },
                    { 14, " Phóng sự đời sống thường nhật của người dân.", "Thời sự", "vi", "Phóng sự", 9, new DateTime(2021, 12, 20, 23, 14, 31, 549, DateTimeKind.Local).AddTicks(2662), null }
                });
