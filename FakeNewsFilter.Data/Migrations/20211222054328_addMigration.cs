        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 22, 12, 43, 28, 470, DateTimeKind.Local).AddTicks(8130)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 22, 12, 43, 28, 470, DateTimeKind.Local).AddTicks(2760))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsId = table.Column<int>(type: "int", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 12, 22, 12, 43, 28, 469, DateTimeKind.Local).AddTicks(820))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7780), 0, 0L, "covid.jpeg", 0, 1 },
                    { 2, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7780), 0, 0L, "taliban.jpeg", 0, 1 },
                    { 3, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7790), 0, 0L, "kinh-te-tg.jpeg", 0, 1 },
                    { 4, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7790), 0, 0L, "ngvietnamchau.jpeg", 0, 1 },
                    { 5, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7790), 0, 0L, "doanh-nghiep.jpeg", 0, 1 },
                    { 6, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7800), 0, 0L, "chon truong.jpeg", 0, 1 },
                    { 7, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7800), 0, 0L, "congnghegame.jpeg", 0, 1 },
                    { 8, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7800), 0, 0L, "congnghemoi.jpeg", 0, 1 },
                    { 9, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7810), 0, 0L, "phongsu.jpeg", 0, 1 },
                    { 10, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7810), 0, 0L, "giaothong.jpeg", 0, 1 },
                    { 11, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7810), 0, 0L, "chungkhoan.jpeg", 0, 1 },
                    { 12, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7820), 0, 0L, "khoahocvn.jpeg", 0, 1 },
                    { 13, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7820), 0, 0L, "the-thao1.jpeg", 0, 1 },
                    { 14, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7820), 0, 0L, "newsid1.jpg", 0, 1 },
                    { 15, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7830), 0, 0L, "newsid2.jpg", 0, 1 },
                    { 16, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7830), 0, 0L, "newsid3.jpg", 0, 1 },
                    { 17, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7830), 0, 0L, "newsid4.jpg", 0, 1 },
                    { 18, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7840), 0, 0L, "newsid5.jpg", 0, 1 },
                    { 19, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7840), 0, 0L, "newsid6.png", 0, 1 },
                    { 20, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7840), 0, 0L, "newsid7.jpg", 0, 1 },
                    { 21, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7850), 0, 0L, "newsid8.jpg", 0, 1 },
                    { 22, null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7850), 0, 0L, "newsid9.jpg", 0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a3314be5-4c77-4fb6-82ad-302014682a73"), "0fa6b41f-5c0e-409d-8825-0dc533371187", "Admin", "Admin" },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), "3230ec48-e39a-42bc-98e8-59fefaf4d424", "Subscriber", "Subscriber" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, null, "0b12ee3a-18bf-4349-8c85-d10cd12a8b36", "bp.khuyen@hutech.edu.vn", true, false, null, "Bui Phu Khuyen", "BP.KHUYEN@HUTECH.EDU.VN", "khuyenpb", "AQAAAAEAACcQAAAAEGJdtVks8KhO85ZCgDvXNYKtVFpVER6uSWjmJZvaCy12U0MDDRhJ1egYqe/5gS63fg==", null, false, "", false, "khuyenpb" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be02de"), 0, null, "0a365965-4a3e-4914-a1da-ee9dfe6409ce", "thanh26092000@gmail.com", true, false, null, "Le Xuan Thanh", "THANH26092000@GMAIL.COM", "LXThanh", "AQAAAAEAACcQAAAAECMQ613OPGYtugoFlA/AFF8rdijgAMqN3rfCug9JsU0xBOoP9XQj6V8DYigrjhfz9g==", null, false, "", false, "LXThanh" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be03de"), 0, null, "85b5b631-5df3-462d-831e-bce19d8d0231", "khanh200111@gmail.com", true, false, null, "Huynh Huu Khanh", "KHANH200111@GMAIL.COM", "hkhansh27", "AQAAAAEAACcQAAAAEN5ZSG5bPB4ThMl7+ePbwjrDSHU4b/9KKybvrmFBUevkoyFFegVZsddrpKafwCKSzw==", null, false, "", false, "hkhansh27" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be04de"), 0, null, "529e85cc-29a6-4c48-bc7b-a69389dc28cb", "hi@phucs.me", true, false, null, "To Hoang Phuc", "HI@PHUCS.ME", "HoangPhuc", "AQAAAAEAACcQAAAAEMeArNKzGttlkaIITJbyr23dRBmrT7TEa9sdC1djAChgd5I5Rkk/eWFx16/srabMGw==", null, false, "", false, "HoangPhuc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Follow live as the Taliban seizes territory across Afghanistan in the wake of the U.S. withdrawal.", "breaking", "en", "afghanistan", null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7680), null },
                    { 2, "Best nonfiction features, in-depth stores and other long-form content from across the web.", "featured", "en", "in-depth", 2, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7710), null },
                    { 3, "Outbreak of respiratory virus that has killed over 1 million and infected 100 milion worldwide.", "featured", "en", "coronavirus", null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7710), null },
                    { 4, "The top business and economic news from around the world with a focus on the United State.", "featured", "en", "top-business", null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7720), null },
                    { 5, "Follow the presidential transition of Joe Biden, including policy plans, appointments and more.", "featured", "en", "biden-admin", null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7720), null },
                    { 6, "Top stories from around the world with a focus on news not covered in other feeds.", "featured", "en", "top-news", null, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7720), null },
                    { 7, "Follow important local news: politics, business, top events and more. Updated everything evening.", "featured", "en", "boston", 1, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7730), null },
                    { 8, "Các thông tin về virut corona.", "Thế giới", "vi", "dịch bệnh", 3, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7730), null },
                    { 9, "Cuộc sống của người Việt Trên toàn thế giới.", "Thế giới", "vi", "người Việt Nam", 4, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7730), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, " Nền doanh nghiệp Việt Nam.", "TÀI CHÍNH - KINH DOANH", "vi", "Kinh tế", 5, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7740), null },
                    { 11, "Chọn trường nghề phù hợp với bản thân.", "GIÁO DỤC", "vi", "học hành", 6, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7740), null },
                    { 12, "Công nghệ mới trong game.", "Trò chơi", "vi", "Trò chơi", 7, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7750), null },
                    { 13, " Sản phẩm công nghệ mới trong năm.", "Công Nghệ", "vi", "Sản phẩm", 8, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7750), null },
                    { 14, " Phóng sự đời sống thường nhật của người dân.", "Thời sự", "vi", "Phóng sự", 9, new DateTime(2021, 12, 22, 12, 43, 28, 478, DateTimeKind.Local).AddTicks(7750), null }
                });
