        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 7, 21, 18, 24, 404, DateTimeKind.Local).AddTicks(1090)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 7, 21, 18, 24, 403, DateTimeKind.Local).AddTicks(2147))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsId = table.Column<int>(type: "int", nullable: false),
                    TopicId = table.Column<int>(type: "int", nullable: false),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 7, 21, 18, 24, 401, DateTimeKind.Local).AddTicks(3223))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7981), 0, 0L, "covid.jpeg", 0, 1 },
                    { 2, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7982), 0, 0L, "taliban.jpeg", 0, 1 },
                    { 3, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7983), 0, 0L, "kinh-te-tg.jpeg", 0, 1 },
                    { 4, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7983), 0, 0L, "ngvietnamchau.jpeg", 0, 1 },
                    { 5, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7984), 0, 0L, "doanh-nghiep.jpeg", 0, 1 },
                    { 6, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7985), 0, 0L, "chon truong.jpeg", 0, 1 },
                    { 7, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7985), 0, 0L, "congnghegame.jpeg", 0, 1 },
                    { 8, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7986), 0, 0L, "congnghemoi.jpeg", 0, 1 },
                    { 9, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7987), 0, 0L, "phongsu.jpeg", 0, 1 },
                    { 10, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7987), 0, 0L, "giaothong.jpeg", 0, 1 },
                    { 11, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7988), 0, 0L, "chungkhoan.jpeg", 0, 1 },
                    { 12, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7989), 0, 0L, "khoahocvn.jpeg", 0, 1 },
                    { 13, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7989), 0, 0L, "the-thao1.jpeg", 0, 1 },
                    { 14, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7990), 0, 0L, "newsid1.jpg", 0, 1 },
                    { 15, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7991), 0, 0L, "newsid2.jpg", 0, 1 },
                    { 16, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7991), 0, 0L, "newsid3.jpg", 0, 1 },
                    { 17, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7992), 0, 0L, "newsid4.jpg", 0, 1 },
                    { 18, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7993), 0, 0L, "newsid5.jpg", 0, 1 },
                    { 19, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7993), 0, 0L, "newsid6.png", 0, 1 },
                    { 20, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7994), 0, 0L, "newsid7.jpg", 0, 1 },
                    { 21, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7994), 0, 0L, "newsid8.jpg", 0, 1 },
                    { 22, null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7995), 0, 0L, "newsid9.jpg", 0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a3314be5-4c77-4fb6-82ad-302014682a73"), "473708eb-62cb-430f-9ded-cacdbdbd63a9", "Admin", "Admin" },
                    { new Guid("b4314be5-4c77-4fb6-82ad-302014682b13"), "b4115ac1-73e1-4265-8135-8f6bce144b88", "Subscriber", "Subscriber" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be01de"), 0, null, "6098d813-31df-4988-9864-74e95ba4b990", "bp.khuyen@hutech.edu.vn", true, false, null, "Bui Phu Khuyen", "BP.KHUYEN@HUTECH.EDU.VN", "khuyenpb", "AQAAAAEAACcQAAAAELCvykA6p+zdVZTYAwP0I1OvoswoUJSjjHOwdi8RLBnv0RyOgv4QTrX+AH96DpApkQ==", null, false, "", false, "khuyenpb" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be02de"), 0, null, "71fe128d-5c2d-473f-8fad-0cb28d3929a7", "thanh26092000@gmail.com", true, false, null, "Le Xuan Thanh", "THANH26092000@GMAIL.COM", "LXThanh", "AQAAAAEAACcQAAAAENBi/zwIVku+ULZJZZza1kBVImhRn7JCd03P/6I4QnYqZt8H10E/9eYqQyfuPb2GzA==", null, false, "", false, "LXThanh" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be03de"), 0, null, "770fe882-a3ec-450a-91d4-80f31dd60c54", "khanh200111@gmail.com", true, false, null, "Huynh Huu Khanh", "KHANH200111@GMAIL.COM", "hkhansh27", "AQAAAAEAACcQAAAAEIa5N3L/EKg4UylgQaGMKLdrLSpFbZp2MQOF4hTIchOB6NWqa16Cd0Y2ktowJ04yuQ==", null, false, "", false, "hkhansh27" },
                    { new Guid("69db714f-9576-45ba-b5b7-f00649be04de"), 0, null, "b83ae42f-31a5-4382-9d5b-160400099be1", "hi@phucs.me", true, false, null, "To Hoang Phuc", "HI@PHUCS.ME", "HoangPhuc", "AQAAAAEAACcQAAAAENQ774lzfnaBdgBAftNXwxYXcmVd6hFOnLIEIb3ReZVxoAQMFEf4r4Wng+IbMz6HJQ==", null, false, "", false, "HoangPhuc" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Follow live as the Taliban seizes territory across Afghanistan in the wake of the U.S. withdrawal.", "breaking", "en", "afghanistan", null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7918), null },
                    { 2, "Best nonfiction features, in-depth stores and other long-form content from across the web.", "featured", "en", "in-depth", 2, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7932), null },
                    { 3, "Outbreak of respiratory virus that has killed over 1 million and infected 100 milion worldwide.", "featured", "en", "coronavirus", null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7933), null },
                    { 4, "The top business and economic news from around the world with a focus on the United State.", "featured", "en", "top-business", null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7934), null },
                    { 5, "Follow the presidential transition of Joe Biden, including policy plans, appointments and more.", "featured", "en", "biden-admin", null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7935), null },
                    { 6, "Top stories from around the world with a focus on news not covered in other feeds.", "featured", "en", "top-news", null, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7936), null },
                    { 7, "Follow important local news: politics, business, top events and more. Updated everything evening.", "featured", "en", "boston", 1, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7937), null },
                    { 8, "Các thông tin về virut corona.", "Thế giới", "vi", "dịch bệnh", 3, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7937), null },
                    { 9, "Cuộc sống của người Việt Trên toàn thế giới.", "Thế giới", "vi", "người Việt Nam", 4, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7938), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 10, " Nền doanh nghiệp Việt Nam.", "TÀI CHÍNH - KINH DOANH", "vi", "Kinh tế", 5, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7939), null },
                    { 11, "Chọn trường nghề phù hợp với bản thân.", "GIÁO DỤC", "vi", "học hành", 6, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7940), null },
                    { 12, "Công nghệ mới trong game.", "Trò chơi", "vi", "Trò chơi", 7, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7941), null },
                    { 13, " Sản phẩm công nghệ mới trong năm.", "Công Nghệ", "vi", "Sản phẩm", 8, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7942), null },
                    { 14, " Phóng sự đời sống thường nhật của người dân.", "Thời sự", "vi", "Phóng sự", 9, new DateTime(2022, 1, 7, 21, 18, 24, 431, DateTimeKind.Local).AddTicks(7945), null }
                });
