 ...
 */
(function(factory){if(typeof define==='function'&&define.amd){define(['jquery','datatables.net-bs4','datatables.net-responsive'],function($){return factory($,window,document)})}else if(typeof exports==='object'){module.exports=function(root,$){if(!root){root=window}
if(!$||!$.fn.dataTable){$=require('datatables.net-bs4')(root,$).$}
if(!$.fn.dataTable.Responsive){require('datatables.net-responsive')(root,$)}
...
_modal.find('div.modal-body').empty().append(render());new bootstrap.Modal(_modal)}}}};return DataTable.Responsive})
